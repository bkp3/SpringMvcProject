						...
						<form action="handleform" method="post">
							...
							<div class="form-group">
								<label for="yourName">Your Name</label> <input type="text"
									class="form-control" id="yourName" aria-describedby="nameHelp"
									placeholder="Enter name" name="name"> <small
									id="nameHelp" class="form-text text-muted">We'll never
									share your name with anyone else.</small>
							</div>

							<div class="form-group">
								<label for="yourId">Your id</label> <input type="text"
									class="form-control" id="yourId" placeholder="Enter ID"
									name="id">
							</div>

							<div class="form-group">
								<label for="yourDob">Your DOB</label> <input type="text"
									class="form-control" id="yourDob" placeholder="dd/mm/yyyy"
									name="date">
							</div>

							<div class="form-group">
								<label for="selectCourse">Select Courses</label> <select
									name="courses" class="form-control" id="selectCourse" multiple>
									<option>Java</option>
